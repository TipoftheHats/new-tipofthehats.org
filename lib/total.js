...
module.exports = function (conf, app) {
	...
	function update() {
		...
		Promise.join(trackerProimise, scraptfPromise, (trackerTotal, scraptfTotal) => {
			...
			if (isNaN(scraptfTotal)) {
				console.warn('scraptfTotal was NaN! Not updating total.');
				return;
			}

			/* eslint-disable spaced-comment */
			const freshTotal = trackerTotal/* + scraptfTotal*/; // Scrap total is now included in the tracker
